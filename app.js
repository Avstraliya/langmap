...
const UI_STRINGS = {
    ...
    pl: { title: 'LangMap', subtitle: 'Wielojęzykowa mapa kolejności słów', selectSentence: 'Wybierz zdanie', langToggle: 'Języki', langOrder: 'Kolejność języków', dragHint: 'przeciągnij, aby zmienić', defaultOrder: 'Domyślna kolejność', random: 'Losowe', prev: '◀', next: '▶', allOn: 'Wszystkie WŁ', allOff: 'Wszystkie WYŁ', savePng: 'Zapisz PNG', saveSvg: 'Zapisz SVG', copyUrl: 'Kopiuj URL', copied: 'Skopiowano URL', uiLang: 'Języki interfejsu:', noLangSelected: 'Wybierz przynajmniej jeden język', selectLangs: 'Wybierz języki ({n})', saveViewCsv: 'Zapisz CSV', saveCsv: 'CSV', ogTitle: 'LangMap - Wielojęzykowa mapa kolejności słów', ogDesc: 'Interaktywna mapa porównująca kolejność słów pomiędzy 220+ językami, dialektami i etapami historycznymi.', selectLangsTitle: 'Wybierz języki', modalConfirm: 'Zastosuj', modalCancel: 'Anuluj', edit: 'Edytuj', save: 'Zapisz', cancel: 'Anuluj', corrector: 'Korektor:', correctionSaved: 'Poprawka zapisana', copyText: 'Skopiuj tekst', copiedText: 'Skopiowano tekst', rtlNote: '* Pisma arabskie i hebrajskie są pokazane od lewej to prawej dla porównania (zwykle są czytane od prawej to lewej)', rtlToggle: 'Pokaż ojczystą kolejność', pending: 'W toku', creditText: 'Stworzone przez <a href="https://heuron.com" target="_blank" rel="noopener">Heuron Inc.</a> — Jounlai Cho', disclaimer: 'Ta strona jest stworzona dla celów naukowych oraz rozrywkowych i nie gwarantuje lingwistycznego rygoru. Jeśli zauważysz błąd lub masz sugestie, prosimy o przesłanie poprawki przez <a href="https://github.com/jounlai/langmap" target="_blank" rel="noopener"> platformę GitHub</a> lub o kontakt z <a href="mailto:cho@heuron.com">autorem</a>.'},
};
...
const FROZEN_UI_LANG_CODES = ['ja','ko','zh','yue','vi','th','id','hi','en','de','fr','it','es','es','pt','pt','ru','uk','ar','he','sw','pl'];
...
const HEADER_UI_LANG_NATIVE = {
    ...
    ru:'Русский', uk:'Українська', ar:'العربية', he:'עברית', sw:'Kiswahili', pl:'Polski',
};
...
function applyUILang() {
    ...
    // Nav labels
    const woLabels = {ja:'語順マップ',ko:'어순 맵',zh:'语序图',yue:'語序圖',vi:'Trật tự từ',th:'ลำดับคำ',id:'Urutan Kata',hi:'शब्द क्रम',en:'Word Order',de:'Wortstellung',fr:'Ordre des mots',it:'Ordine parole',es:'Orden de palabras',pt:'Ordem das palavras',ru:'Порядок слов',uk:'Порядок слів',ar:'ترتيب الكلمات',he:'סדר מילים',sw:'Mpangilio wa maneno',pl:'Kolejność słów'};
    const wmLabels = {ja:'単語マップ',ko:'단어 맵',zh:'词汇地图',yue:'詞彙地圖',vi:'Bản đồ từ',th:'แผนที่คำ',id:'Peta Kata',hi:'शब्द मानचित्र',en:'Word Map',de:'Wortkarte',fr:'Carte des mots',it:'Mappa parole',es:'Mapa de palabras',pt:'Mapa de palavras',ru:'Карта слов',uk:'Карта слів',ar:'خريطة الكلمات',he:'מפת מילים',sw:'Ramani ya maneno',pl:'Mapa słów'};
    ...
    const trLabels = {ja:'系統樹',ko:'계통수',zh:'谱系树',yue:'譜系樹',vi:'Cây phả hệ',th:'แผนภูมิ',id:'Pohon',hi:'वृक्ष',en:'Tree',de:'Stammbaum',fr:'Arbre',it:'Albero',es:'Árbol',pt:'Árvore',ru:'Древо',uk:'Дерево',ar:'الشجرة',he:'אילן',sw:'Mti',pl:'Drzewo'};
...
const GROUP_NAMES = {
    ...
    pl: {"JPN":"Japońskie","KOR":"Koreańskie","CHN":"Sinickie","TIB":"Tybeto-birmańskie","SEA":"Azja Płd.-Wsch. i austronezyjskie","AUS":"Austronezyjskie (Oceania)","SAS":"Azja Południowa","TRK":"Turkijskie","MON":"Mongolskie","TNG":"Tunguskie","KAR":"Kartwelskie","SEM":"Semickie","ANE":"Starożytne Bliskiego Wschodu","AFR":"Afrykańskie","PIE":"Proto-indo-europejskie","GER":"Germańskie","CEL":"Celtyckie","ROM":"Romańskie","SLV":"Słowiańskie","OEU":"Bałtyckie, helleńskie, uralskie itp.","AMR":"Ameryki","CRL":"Kreolskie i pidżynowe","CON":"Sztuczne"},
};
